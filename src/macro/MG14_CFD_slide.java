    ...
    public class SimRunner {
        ...
        public void RotateCS(SimData sD) {
            ...
            if (sD.getAngle() != 0) {
                ...
                Units u_Angle = m_simUsed.getUnitsManager().getPreferredUnits(Dimensions.Builder().angle(1).build());
                
                Units u_Lines = m_simUsed.getUnitsManager().getPreferredUnits(Dimensions.Builder().length(1).build());
